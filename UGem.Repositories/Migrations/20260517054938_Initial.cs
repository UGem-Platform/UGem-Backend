    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), null, new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "admin@ugem.com", "System Administrator", true, false, "$2a$11$GLRXH4kiG6pIpd5jXH6OiOcY5CO03T8FdRVX7Nj.iH8IXO.TfidGq", "0123456789", "Admin", null },
                    { new Guid("19191919-1919-1919-1919-191919191919"), null, new DateTimeOffset(new DateTime(2026, 4, 21, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "staff.ngoc@ugem.com", "Lê Bảo Ngọc", true, false, "$2a$11$haofTTGEbjrfSY40yT1IQe1SWnr2t.P3LLlGJSh6OFdG6K3yHTEzy", "901111111", "Staff", null },
                    { new Guid("20202020-2020-2020-2020-202020202020"), null, new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "hungsui@gmail.com", "Trần Văn Hùng", true, false, "$2a$11$dIA15dopqDXQO3k96Jmo7eIpFFW3bcxiwZYLJq0hfptUW0fDMMsTe", "902222222", "Customer", null },
                    { new Guid("33333333-3333-3333-3333-333333333333"), null, new DateTimeOffset(new DateTime(2026, 4, 23, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "staff.duyet@ugem.com", "Nguyen Tran Admin", true, false, "$2a$11$2Skqayq064pRYx34N3KCcOYn.5T7.cJy/pjV3ECicwKCrgB2csIdq", "0901000001", "Staff", null },
                    { new Guid("55555555-5555-5555-5555-555555555555"), null, new DateTimeOffset(new DateTime(2026, 4, 23, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "chuquan.bun@ugem.com", "Tran Bun Cha", true, false, "$2a$11$R455MtteOIAufMFtmlsawewVQHDXY.ZrrnSPGZF46x8bzWys5U95O", "0902000002", "Customer", null },
                    { new Guid("77777777-7777-7777-7777-777777777777"), null, new DateTimeOffset(new DateTime(2026, 4, 23, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "chuquan.che@ugem.com", "Le Thi Che", true, false, "$2a$11$RgAEu2XjSpI3g9A5WUKgOu0cG6ZzfifjuGPDvXS8OuSXKG4sp/bL2", "0902000003", "Merchant", null },
                    { new Guid("99999999-9999-9999-9999-999999999999"), null, new DateTimeOffset(new DateTime(2026, 4, 23, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "khach.sanh@ugem.com", "Pham Thuc Khach", true, false, "$2a$11$5r9ijXJFGsMo5QXylc2Sxul4xMzvW4iB7zrKnMUIupF8xLPZqjwAu", "0903000004", "Reviewer", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("11111111-1111-1111-1111-111111111111"), 0m, 0m, new DateTimeOffset(new DateTime(2026, 5, 17, 5, 49, 37, 175, DateTimeKind.Unspecified).AddTicks(2107), new TimeSpan(0, 0, 0, 0, 0)), new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), false, 55, "Gold", new DateTimeOffset(new DateTime(2026, 5, 17, 5, 49, 37, 175, DateTimeKind.Unspecified).AddTicks(2115), new TimeSpan(0, 0, 0, 0, 0)) });
