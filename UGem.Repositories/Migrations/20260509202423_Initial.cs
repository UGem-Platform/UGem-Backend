    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), null, new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "admin@ugem.com", "System Administrator", true, false, "$2a$11$77OHL9C.2WjH1HOrIxBYCOE5H9ezfQTNwLysOiLHiIGyIW6JlPMIC", "0123456789", "Admin", null },
                    { new Guid("19191919-1919-1919-1919-191919191919"), null, new DateTimeOffset(new DateTime(2026, 4, 21, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "staff.ngoc@ugem.com", "Lê Bảo Ngọc", true, false, "$2a$11$f/LKoxwBBv0LIiwEkdXMJuP2zcpm3g1DJqWVCDetQSUZ8M.WpX3KS", "901111111", "Staff", null },
                    { new Guid("20202020-2020-2020-2020-202020202020"), null, new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "hungsui@gmail.com", "Trần Văn Hùng", true, false, "$2a$11$NlZN.xacm2s.WvmYX3cyHe9MBNJqWhRiLi8TCvNBhK2MFFL6jEk..", "902222222", "Customer", null },
                    { new Guid("33333333-3333-3333-3333-333333333333"), null, new DateTimeOffset(new DateTime(2026, 4, 23, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "staff.duyet@ugem.com", "Nguyen Tran Admin", true, false, "$2a$11$V9fqJVL/YX8KILYYq2lofOS/ALxgUfl1imUgguyn5AYyF4/kSzgY2", "0901000001", "Staff", null },
                    { new Guid("55555555-5555-5555-5555-555555555555"), null, new DateTimeOffset(new DateTime(2026, 4, 23, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "chuquan.bun@ugem.com", "Tran Bun Cha", true, false, "$2a$11$CldXW8KazSyksTW7NnV6Y.HT4tImUKktRIiB.m6MDMUmcJyxTRszq", "0902000002", "Customer", null },
                    { new Guid("77777777-7777-7777-7777-777777777777"), null, new DateTimeOffset(new DateTime(2026, 4, 23, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "chuquan.che@ugem.com", "Le Thi Che", true, false, "$2a$11$BeSnDD4vb/RMsTO1rwBHdeHmRsrqxo70oAbDlxkWRifiLV8eoNKO6", "0902000003", "Merchant", null },
                    { new Guid("99999999-9999-9999-9999-999999999999"), null, new DateTimeOffset(new DateTime(2026, 4, 23, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "khach.sanh@ugem.com", "Pham Thuc Khach", true, false, "$2a$11$LS3mH10Ry4v.XMrlIsom1ejWzjHRkWIuwZVfxlSvfYic5NqXgPru6", "0903000004", "Customer", null }
                });
